                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <div class="collapse show" id="navbar-dashboards">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="/dashboard/analilis" class="nav-link">Analynis</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#navbar-examples" data-toggle="collapse" role="button"
                            ...
                            <span class="nav-link-text">Data Data</span>
                        </a>
                        <div class="collapse" id="navbar-examples">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="dashboard/boking" class="nav-link">Tambah Olderan</a>
                                </li>
                                <li class="nav-item">
                                    <a href="dashboard/mobil" class="nav-link">Tambah Mobil</a>
                                </li>
                                <li class="nav-item">
                                    <a href="dashboard/supir" class="nav-link">Tambah Supir</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/dashboard/history/">
                            ...
                            <span class="nav-link-text">History Orderan</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="navbar-components">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="dashboard/tuneup" class="nav-link">Tuneup</a>
                                </li>
                                <li class="nav-item">
                                    <a href="dashboard/bensin" class="nav-link">Bahan Bakar</a>
                                </li>
                                <li class="nav-item">
                                    <a href="dashboard/gajisupir" class="nav-link">Gaji Supir</a>
                                </li>
                            </ul>
                        </div>
                    </li>
