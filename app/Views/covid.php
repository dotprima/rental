...
$ID = getdata('https://covid19.mathdro.id/api/countries/indonesia');
    ...
    <div class="main-content" id="panel">
                    ...
                    <div class="navbar-search navbar-search-light form-inline mr-sm-3" id="navbar-search-main">
                        <div class="form-group mb-0">
                            <div class="input-group input-group-alternative input-group-merge">
                                ...
                                <input type="text" id="name" placeholder="Negara" class="form-control" />
                            ...
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mt-3 mb-0 text-sm">
                                        ...
                                        <span class=""><?=waktu($lastUpdate)?></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span
                                                class="h2 font-weight-bold mb-0"><?=number_format($recovered["value"])?></span>
                                        </div>
                                        <div class="col-auto">
                                            <div
                                                class="icon icon-shape bg-gradient-green text-white rounded-circle shadow">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span
                                                class="h2 font-weight-bold mb-0"><?=number_format($confirmed["value"])?></span>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span
                                                class="h2 font-weight-bold mb-0"><?=number_format($deaths["value"])?></span>
                                        </div>
                                        <div class="col-auto">
                                            <div
        ...
        <div class="container-fluid mt--6">
            <div class="row">
                <div class="col-xl-8">
                    <div class="card">
                        <img style="border-radius:20px" src="https://covid19.mathdro.id/api/og" alt="">
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card bg-gradient-danger">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0 text-white">Indonesia
                                            data
                                        </h5>
                                ...
                                <p class="mt-3 mb-0 text-sm">
                                    ...
                                    <span class="text-nowrap text-light"><?=waktu($ID["lastUpdate"])?></span>
                                </p>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <?=number_format($ID["confirmed"]["value"])?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="mr-2"><?=round(getpersen($ID["confirmed"]["value"],$confirmed["value"]),2)?>%</span>
                                                <div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-danger" role="progressbar"
                                                            aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                                                            style="width: <?=round(getpersen($ID["confirmed"]["value"],$confirmed["value"]),2)?>%;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?=number_format($ID["recovered"]["value"])?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="mr-2"><?=round(getpersen($ID["recovered"]["value"],$recovered["value"]),2)?>%</span>
                                                <div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-success" role="progressbar"
                                                            aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"
                                                            style="width: <?=round(getpersen($ID["recovered"]["value"],$recovered["value"]),2)?>%;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?=number_format($ID["deaths"]["value"])?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <span
                                                    class="mr-2"><?=round(getpersen($ID["deaths"]["value"],$deaths["value"]),2)?>%</span>
                                                <div>
                                                    <div class="progress">
                                                        <div class="progress-bar bg-gradient-primary" role="progressbar"
                                                            aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
                                                            style="width: <?=round(getpersen($ID["deaths"]["value"],$deaths["value"]),2)?>%;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
